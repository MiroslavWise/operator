...
{/* <p>Вы пополнили свой счёт на {formik.values.number} рубля</p> */}
// `${formik.values.lastName}, спасибо за успешное пополнение!`
import './styleForm.css'
import { title } from 'process';

const VisibleModal = ({title, content, close}) => {
return <Modal
          visible={isModal}
          title={title}
          content={content}
      ...
      <Link to="/"><button>На главную</button></Link>
        {
           ...
           onClose={<Link to="/"><button>На главную</button></Link>}/>
           :
           <VisibleModal 
